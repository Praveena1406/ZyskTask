...
import React, { useState } from 'react';
import '../../src/FAQ/FAQPage.css';
import contactImage from '../../src/images/Avatar group.png'; // Path to your image
    ...
    <div className="faq-container" id="faq">
      ...
      <div className="faq-list">
        {faqs.map((faq, index) => (
          ...
          <div className="contact-section">
          <img src={contactImage} alt="Contact" className="contact-image" /> {/* Displaying the image */}
          <h3>Still have questions?</h3>
